  ...
  return (
    <main>
      ...
      <section className="p-4">
        <div className="w-full pt-48 pb-36 rounded-xl relative border bg-neutral-950 text-white px-4">
          <div className="z-10 relative flex flex-col items-center">
            ...
            <p className="md:text-lg text-neutral-300 max-w-xl text-center mt-2 md:mt-4 xl:mt-6">Effortlessly schedule, manage, and track appointments—all in one place. Our user-friendly platform ensures that booking is quick, easy, and accessible anytime, from any device.</p>
            <div className="flex items-center gap-4 mt-4 xl:mt-6">
              <Link href="/">
                <Button className="dark" size="lg">Get Started</Button>
              </Link>
            </div>
          </div>
          <GridPattern
            ...
            y={-1}
            className={cn(
              "stroke-neutral-600/30 dark:stroke-neutral-700/30 [mask-image:radial-gradient(600px_circle_at_center,white,transparent)]",
            )}
          />
        </div>
      </section>
