      ...
      <section className="p-3 md:p-4">
        <div className="w-full pt-48 pb-36 rounded-xl relative border bg-neutral-50 dark:bg-neutral-950 dark:text-white px-4">
          ...
          <GridPattern
            ...
            y={-1}
            className={cn(
              "stroke-neutral-400/20 lg:stroke-neutral-400/30 dark:stroke-neutral-700/30 [mask-image:radial-gradient(400px_circle_at_center,white,transparent)] lg:[mask-image:radial-gradient(600px_circle_at_center,white,transparent)]",
            )}
          />
        </div>
      </section>
