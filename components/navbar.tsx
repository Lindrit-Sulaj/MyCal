...
function Navbar() {
  ...
  return (
    <nav className='px-4 md:px-8'>
      <div className="max-w-screen-xl mx-auto py-4 flex justify-between items-center">
        <div className="flex items-center gap-x-6">
          ...
          <ul className='flex items-center gap-x-4 text-[15px] text-foreground/80'>
            <li>
              <a href="https://www.lindritsulaj.com">Developer</a>
            </li>
            <li>
    ...
    // <nav className='px-8 md:px-12 lg:px-14 sticky top-0 z-50 w-full'>
